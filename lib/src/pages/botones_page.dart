...
class BotonesPage extends StatelessWidget {
  ...
  Widget _fondoApp() {
    ...
    final gradienteRosa = Transform.rotate(
      angle: -pi / 5.0,
      child:  Container(
        height: 360.0,
        width: 360.0,
    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Classiy transaction', style: TextStyle( color: Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold ) ),
            SizedBox( height: 10.0 ),
            Text('Classiy this transaction into a particular category', style: TextStyle( color: Colors.white, fontSize: 18.0 ) ),
          ],
        ),
      ),
    );
  ...
  Widget _botonesRedondeados() {
    ...
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.blueAccent , Icons.movie_filter, 'Entretamient' ),
